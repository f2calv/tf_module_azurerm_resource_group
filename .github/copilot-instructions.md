...
This repository publishes a single reusable Terraform child module that provisions an Azure resource group, the container every other module's resources are created in.
